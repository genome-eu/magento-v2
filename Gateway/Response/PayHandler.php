...
class PayHandler implements HandlerInterface
{
    ...
    public function handle(array $handlingSubject, array $response)
    {
        ...
        $transactionId = $this->subjectReader->readTransactionId($handlingSubject) ?? $payment->getAdditionalInformation(Config::GENOME_TRANSACTION_ID);
        $payment->setAdditionalInformation(Config::GENOME_TRANSACTION_ID, $transactionId);
